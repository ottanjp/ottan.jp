...
作成したグループに対してドメイン名を入力します。弊サイトの場合は「ottan.jp」がドメインになります。「http://」や「www」は抜いてください。末尾の「/」も不要です。
